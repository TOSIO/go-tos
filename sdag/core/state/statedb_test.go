...
func TestIntermediateLeaks(t *testing.T) {
	...
	transDb := tosdb.NewMemDatabase()
	finalDb := tosdb.NewMemDatabase()
...
func TestCopy(t *testing.T) {
	...
	orig, _ := New(common.Hash{}, NewDatabase(tosdb.NewMemDatabase()))
...
func (test *snapshotTest) run() bool {
	...
	var (
		state, _     = New(common.Hash{}, NewDatabase(tosdb.NewMemDatabase()))
...
func TestCopyOfCopy(t *testing.T) {
	sdb, _ := New(common.Hash{}, NewDatabase(tosdb.NewMemDatabase()))
