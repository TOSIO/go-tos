...
func newTestLDB() (*tosdb.LDBDatabase, func()) {
	dirname, err := ioutil.TempDir(os.TempDir(), "tosdb_test_")
	if err != nil {
...
func TestMemoryDB_PutGet(t *testing.T) {
	testPutGet(tosdb.NewMemDatabase(), t)
}

func testPutGet(db tosdb.Database, t *testing.T) {
	t.Parallel()
...
func TestMemoryDB_ParallelPutGet(t *testing.T) {
	testParallelPutGet(tosdb.NewMemDatabase(), t)
}

func testParallelPutGet(db tosdb.Database, t *testing.T) {
	const n = 8
