...
// test all variations.
func makeProvers(trie *Trie) []func(key []byte) *tosdb.MemDatabase {
	var provers []func(key []byte) *tosdb.MemDatabase

	// Create a direct trie based Merkle prover
	provers = append(provers, func(key []byte) *tosdb.MemDatabase {
		proof := tosdb.NewMemDatabase()
