...
type Database struct {
	diskdb tosdb.Database // Persistent storage for matured trie nodes
...
func NewDatabase(diskdb tosdb.Database) *Database {
	return &Database{
		diskdb:    diskdb,
...
func (db *Database) commit(hash common.Hash, batch tosdb.Batch) error {
